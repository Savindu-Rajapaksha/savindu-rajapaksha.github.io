  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-transparent">
        ...
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <h2 className="text-xl font-semibold tracking-wider text-white text-opacity-90">
                WELCOME TO MY WORLD
              </h2>
            ...
            <div className="flex flex-wrap gap-4">
              {skills.map((skill, index) => (
                <div
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-full bg-gray-800/80 border border-gray-700 transition-all duration-500 ease-in-out hover:scale-110 hover:border-cyan-900 hover:shadow-lg hover:shadow-cyan-500/20 ${
                    isVisible
                      ? "transform-none opacity-100"
                      : "-translate-x-full opacity-0"
                  }`}
            ...
            <p className="max-w-2xl text-lg text-white text-opacity-80 leading-relaxed p-6 bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-gray-700 shadow-lg shadow-black/10">
            ...
            <div className="flex flex-wrap items-center gap-6">
              <a 
                ...
                className="relative overflow-hidden px-8 py-3 rounded-full bg-gradient-to-r from-blue-500 via-cyan-500 to-blue-400 bg-[length:200%_auto] font-semibold tracking-wide text-white shadow-lg shadow-cyan-500/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-cyan-500/60 transition-all duration-500 ease-in-out"
              >
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <div className="relative p-3 bg-gray-800/80 rounded-full border border-gray-700 transition-all duration-400 ease-in-out hover:border-cyan-900 hover:scale-110">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
        <ChevronDown className="w-8 h-8 text-white text-opacity-50 animate-bounce" />
      </div>
    </div>
  );
};
