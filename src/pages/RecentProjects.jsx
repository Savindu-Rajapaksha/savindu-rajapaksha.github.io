  ...
  const webProjects = [
    {
      ...
      description: "Rates.lk is a collaboratively developed web solution to know the latest rates and many things. The website is still growing.",
      status: "Online",
      statusColor: "green",
      category: "Web",
      technologies: [
  ...
  const standaloneProjects = [
    {
      ...
      description: "Effice.io is a collaboratively developed web solution for a remotely working startup company",
      status: "Offline",
      statusColor: "gray",
      category: "Standalone",
      technologies: [
    ...
    },
    {
      ...
      description: "A web based user guide solution to help people who use to create bootable drives in day to day life",
      status: "Offline",
      statusColor: "gray",
      category: "Standalone",
      technologies: [
